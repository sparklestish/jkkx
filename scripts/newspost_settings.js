...
// A button will call this function
 ...
 function getPhoto() {
  ...
  function uploadPhoto() {
    ...
    //var imageURI = document.getElementById('myImageUrl').getAttribute("src");
    // if (!imageURI) {
    ...
    options.params = {
        post_desc: document.getElementById("new_post_desc").value,
        phonenum: document.getElementById("lastname").value
    }
    ...
    ft.upload(imageURI, encodeURI("http://envisiongh.net/rogha2016/upload.php"), win, fail,
